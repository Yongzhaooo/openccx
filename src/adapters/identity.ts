 ...
 * advertised "...served through / running via the openccx proxy", which leaked our proxy identity
...
/** Proxy-neutral replacement: no "openccx proxy" mention, just the GPT-5/OpenAI disclaimer. */
