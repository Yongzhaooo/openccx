import type { OccxContentPart, OccxToolCall, OccxToolResultMessage } from "../types";
...
function contentText(content: string | OccxContentPart[]): string {
...
export function toolCallFallbackText(toolCall: OccxToolCall): string {
  return [
...
export function toolResultFallbackText(toolResult: OccxToolResultMessage): string {
  return [
