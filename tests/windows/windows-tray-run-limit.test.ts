...
describe("windows tray Run registration (#696)", () => {
  test("short wscript Run command stays within the 260-character Windows limit under long paths", () => {
    const longHome = "C:\\Users\\VeryLongWindowsUserNameForTestingPaths\\AppData\\Roaming\\npm\\node_modules\\@bitkyc08\\openccx";
    const entry = {
      bun: `${longHome}\\node_modules\\bun\\bin\\bun.exe`,
      cli: `${longHome}\\src\\cli\\index.ts`,
      script: "C:\\Users\\VeryLongWindowsUserNameForTestingPaths\\.openccx\\openccx-tray.ps1",
      codexHome: "C:\\Users\\VeryLongWindowsUserNameForTestingPaths\\.codex",
      openccxHome: "C:\\Users\\VeryLongWindowsUserNameForTestingPaths\\.openccx",
      launcherPath: "C:\\Users\\VeryLongWindowsUserNameForTestingPaths\\.openccx\\openccx-tray.vbs",
    };
    ...
    expect(runCommand).toContain("openccx-tray.vbs");
