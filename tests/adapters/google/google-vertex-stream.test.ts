...
async function collect(provider: OccxProviderConfig, chunks: unknown[]): Promise<AdapterEvent[]> {
...
const vertexProvider = { adapter: "google", baseUrl: "https://x", googleMode: "vertex" } as OccxProviderConfig;
