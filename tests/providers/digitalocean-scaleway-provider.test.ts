...
const DIGITALOCEAN_FIXTURE = readFileSync(fixturePath("digitalocean-models.json"), "utf8");
const SCALEWAY_FIXTURE = readFileSync(fixturePath("scaleway-models.json"), "utf8");
