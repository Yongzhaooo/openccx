 ...
 * an ordinary `occx ...` invocation.
 */
export const NODE_LAUNCH_CONTEXT_ENV = "OCCX_NODE_LAUNCH_CONTEXT";
export const NODE_LAUNCH_PROOF_PREFIX = "--occx-internal-launch-proof=";
