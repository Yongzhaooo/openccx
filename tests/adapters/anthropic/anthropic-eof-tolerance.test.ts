...
function providerFor(extra: Partial<OccxProviderConfig> = {}): OccxProviderConfig {
  return {
    adapter: "anthropic",
...
async function collect(provider: OccxProviderConfig, events: string[]): Promise<AdapterEvent[]> {
