...
const NATIVE_FETCH_DISABLED =
  "Re-issue this fetch NOW through the catalog shell tool `shell_command` (aliases: `exec_command`, `mcp_openccx-responses_shell_command`, `mcp_openccx-responses_exec_command`) with curl or wget. Do NOT narrate this redirect or comment on tool availability — just make the bridge call.";
