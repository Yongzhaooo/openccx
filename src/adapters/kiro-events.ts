...
export type ParsedKiroEvent =
  ...
  | { type: "metadata"; usage?: OccxUsage; contextUsagePercentage?: number; stopReason?: string }
...
function parseTokenUsage(eventType: string, value: unknown): OccxUsage | undefined {
  if (value === undefined || value === null) return undefined;
