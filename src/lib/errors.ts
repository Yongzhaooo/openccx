export interface OccxErrorPayload {
  message: string;
  type: string;
  code: string | null;
}
...
export function classifyError(status: number, type: string, message: string): OccxErrorPayload {
...
export function adapterFailureFromMessage(message: string): { httpStatus: number; error: OccxErrorPayload } {
