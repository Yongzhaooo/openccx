...
- 선택한 방식: Preserve text detection, then use the native token probe only for status-1 creation of the owned `openccx-proxy` XML task. Unknown probe results fail closed.
