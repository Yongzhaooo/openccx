...
- 기존 구현 및 제약 조건: Bun auto-loads project dotenv before Openccx TypeScript evaluates, while provider interpolation still depends on that behavior and cannot be disabled globally.
