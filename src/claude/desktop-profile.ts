...
export type DesktopFamily = OccxClaudeDesktopFamily;
export type DesktopProfile = OccxClaudeDesktopProfile;
...
export function parseDesktopProfile(value: unknown): DesktopProfile {
  ...
  const assignments: Record<string, OccxClaudeDesktopAssignment> = {};
