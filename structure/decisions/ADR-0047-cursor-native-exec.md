...
- 다른 대안 대신 이 방식을 선택한 이유: openccx has no trustworthy per-request sandbox attestation in request text or headers, so any prompt-carried marker is spoofable by data-plane callers.
