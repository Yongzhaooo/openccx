...
function umansProvider(apiKey = "sk-umans", apiKeyTransport?: OccxProviderConfig["apiKeyTransport"]): OccxProviderConfig {
  return {
    adapter: "anthropic",
...
function parsedWithWebSearchTool(): OccxParsedRequest {
  return {
    modelId: "umans-coder",
    context: {
