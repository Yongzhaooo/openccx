...
beforeEach(() => {
  ...
  isolatedCodexHome = installIsolatedCodexHome("occx-xai-401-codex-");
  testDir = mkdtempSync(join(tmpdir(), "occx-xai-401-"));
...
function xaiConfig(authMode: "oauth" | "key" = "oauth"): OccxConfig {
  return {
    port: 0,
    hostname: "127.0.0.1",
    defaultProvider: "xai",
