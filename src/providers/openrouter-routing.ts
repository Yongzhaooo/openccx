import type { OccxProviderConfig, OpenRouterProviderRouting } from "../types";
...
export function openRouterRoutingConfigError(provider: OccxProviderConfig): string | null {
