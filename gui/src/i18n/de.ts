...
"common.discard": "Verwerfen",
  ...
  "auth.adminTokenTitle": "Openccx-Admin-Token (OPENCCX_ADMIN_AUTH_TOKEN)",
  ...
  "auth.adminTokenHelp": "Dies ist der Admin-Token der Openccx-Verwaltungs-API, kein Anbieter-API-Schlüssel. Beim ersten Start schreibt der Proxy ihn nach ~/.opencodex/admin-api-token (oder $OPENCCX_HOME/admin-api-token); OPENCCX_ADMIN_AUTH_TOKEN hat Vorrang.",
  ...
  "startup.subtitle": "Prüft, ob Codex openccx nach einem Neustart erreicht, bevor lokales Proxy-Routing in einer Wiederverbindungsschleife endet.",
  ...
  "startup.summary.protected": "openccx ist nach einem Neustart verfügbar",
  ...
  "startup.riskDetailCustomLocal": "Codex verwendet ein benutzerdefiniertes lokales Gateway. openccx kann dessen Neustart-Lebenszyklus weder verwalten noch prüfen.",
  ...
  "startup.safeDetail": "Routing und Startmechanismus stimmen überein. Nach einem Neustart sollte kein manuelles occx start nötig sein.",
  ...
  "startup.shimHint": "Führt occx ensure aus, wenn ein unterstützter Codex-Skript-Launcher startet.",
  ...
  "startup.tray.error": "Die Windows-Infobereichsaktion ist fehlgeschlagen. Details: occx tray status.",
  ...
  "startup.codexRuntime.clampHidden": "Einige Reasoning-Effort-Optionen wurden ausgeblendet, weil Openccx Codex {version} verwendet hat.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Einige Reasoning-Effort-Optionen wurden ausgeblendet, weil Openccx Codex {version} verwendet hat (entfernt: {efforts}).",
  "startup.codexRuntime.olderBinary": "Openccx verwendet eine ältere Codex-Binary ({version}). Eine neuere Installation ist verfügbar.",
  "dash.subtitle": "Live-Status des lokalen openccx-Proxys, seiner Anbieter und der in Codex gerouteten Modelle.",
  ...
  "dash.codexAutoStart": "openccx mit Codex starten",
  "dash.codexAutoStartHint": "Erlaubt einem installierten Launcher-Shim, occx ensure auszuführen. Diese Einstellung installiert keinen Neustartschutz; prüfe den effektiven Zustand unter Startsicherheit.",
  ...
  "dash.shadowCallTooltip": "Die Codex-App ruft im Hintergrund ein Hilfsmodell für Titelgenerierung, Commit-Nachrichten und Skill-Orchestrierung auf. Das Modell wechselt zwischen Client-Versionen, daher fängt openccx diesen Satz ab: {models}.",
  ...
  "dash.maintenanceHint": "Aktualisiere Codex’ Modellkatalog oder installiere eine neuere openccx-Version.",
  ...
  "dash.projectConfigTitle": "Projekt-Codex-Konfig umgeht Openccx",
  "dash.projectConfigHint": "Diese repo-lokalen Einstellungen überschreiben den Openccx-Proxy (z. B. direkt zu OpenCode Go routen). Entferne sie, damit die Routing aus ~/.codex/config.toml in diesem Projekt greift.",
  "dash.checkUpdate": "Update prüfen",
  "dash.updateTitle": "openccx aktualisieren",
  ...
  "dash.updateStatus.running": "openccx wird aktualisiert.",
  ...
  "prov.subtitle": "Konfiguriere die Upstream-Anbieter, die openccx in Codex routet. Melde dich mit einem Konto an, füge einen Anbieter hinzu oder bearbeite die Rohkonfiguration.",
  ...
  "oauthTos.anthropicBody": "Die direkte Wiederverwendung von Claude-Abo-OAuth-Tokens über einen Drittanbieter-Proxy wie Openccx ist keine von Anthropic unterstützte Integration und kann zu Zugriffsbeschränkungen führen. Unterstützte Agent-SDK-Integrationen, die Claude-Abos verwenden, sind davon getrennt.",
  "oauthTos.highBody": "Openccx verbindet {provider} über einen OAuth-Pfad eines Drittanbieters. Bei nicht unterstützter Nutzung kann der Zugriff eingeschränkt oder gesperrt werden.",
  "oauthTos.elevatedBody": "Openccx verbindet {provider} über einen inoffiziellen OAuth-Pfad. Nutze nach Möglichkeit den offiziellen Client; ungewöhnlicher oder automatisierter Traffic kann als Missbrauch gewertet und der Zugriff eingeschränkt oder gesperrt werden.",
  "oauthTos.saferPath": "Sicherere Option: Hinterlege stattdessen einen API-Schlüssel in Openccx.",
  ...
  "sub.subtitle": "Codex {cmd} bewirbt nur die ersten 5 Modelle (nach Priorität) als Overrides. Wähle hier bis zu 5 — natives gpt oder geroutet — und openccx setzt ihre Katalog-Priorität, sodass genau diese führen. Jedes andere Modell bleibt über seinen exakten Namen aufrufbar; dies steuert nur die Anzeige.",
  ...
  "logs.subtitle": "Letzte Anfragen über den lokalen openccx-Proxy, neueste zuerst.",
...
"codexSet.custom.moveUp": "{title} nach oben verschieben",
  ...
  "codexSet.custom.notOwned": "developer_instructions wurde außerhalb von openccx geschrieben und kann daher hier nicht bearbeitet werden. Importiere den Inhalt, um ihn als Ebene zu verwalten.",
  ...
  "codexSet.custom.baseReplaced": "model_instructions_file ist auf {path} gesetzt. Daher wurde der Basis-Prompt außerhalb von openccx ersetzt.",
...
"codexSet.lint.size": "Diese Ebene ist größer als 8 KB. Sie kann trotzdem gespeichert werden, verbraucht aber bei jeder Anfrage Tokens.",
  ...
  "codexSet.preset.korean.provenance": "Für openccx aus einem häufig gewünschten Standard verfasst. Eigene Formulierung, keine Kopie.",
...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
  ...
  "codexSet.base.externalBlocked": "model_instructions_file zeigt bereits auf {path}, und das hat nicht openccx geschrieben. Entfernen Sie es selbst, bevor Sie hier auswählen.",
  "nav.api": "API",
  ...
  "integrations.subtitle": "Clients mit openccx verbinden, Zugangsdaten verwalten und Client-Konfigurationen wiederherstellen.",
  ...
  "integrations.codex.body": "Die Codex-Anbindung wird vom Proxy-Dienst verwaltet. Beim Start von openccx wird sie angewendet; beim Stoppen des Dienstes wird das native Routing wiederhergestellt.",
  ...
  "integrations.dialog.desktop.changes": "Falls {path} ein von openccx verwaltetes Gateway-Profil enthält, wählt Desktop zuerst ein neues Standardprofil ohne Zugangsdaten und entfernt danach das alte Profil und dessen Sicherung.",
  "integrations.dialog.desktop.breakage": "Claude Desktop verwendet dann statt über openccx gerouteter Modelle wieder das standardmäßige Claude.",
  "integrations.dialog.desktop.undo": "Beim erneuten Aktivieren wird das openccx-Profil aus deinen gespeicherten Modellzuweisungen neu erstellt.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop zeigt auf den Standardmodus, aber alte openccx-Zugangsdaten befinden sich noch unter: {paths}.",
  ...
  "integrations.detail.grokAbsent": "Kein openccx-Block in der Konfiguration",
  "integrations.dialog.codex.title": "Codex-Integration deaktivieren?",
  "integrations.dialog.codex.changes": "openccx entfernt seine Weiterleitung aus {path}, entfernt sein generiertes Profil, stellt den nativen Modellkatalog wieder her und kennzeichnet fortsetzbare Threads wieder für natives Codex.",
  ...
  "integrations.dialog.codex.sideEffect": "Wenn du nach der Injektion durch openccx ein geroutetes Root-Modell ausgewählt hast, entfernt das Deaktivieren diese Auswahl; beim erneuten Aktivieren kann sie nicht rekonstruiert werden — wähle das Modell erneut. Wenn ein externer model_provider Codex besitzt, entfernt openccx nur sein veraltetes Journal und lässt Konfiguration, Katalog und Verlauf unverändert.",
  "integrations.dialog.codex.confirm": "Deaktivieren",
  "integrations.dialog.grok.title": "Grok-Build-Integration deaktivieren?",
  "integrations.dialog.grok.changes": "Aus {path} wird nur der von openccx markierte Block entfernt. Manuell geschriebener Inhalt außerhalb des Blocks bleibt unverändert.",
  "integrations.dialog.grok.breakage": "Nach dem Deaktivieren verschwinden die openccx-Modellaliase aus Grok Build. Modelle, die mit dem xAI-Konto verwendet wurden, bleiben erhalten.",
  "integrations.dialog.grok.undo": "Wenn openccx unter einer Loopback-Adresse läuft, wird beim erneuten Aktivieren ein neuer Block aus der aktuell verfügbaren Modellliste geschrieben.",
  "integrations.dialog.grok.confirm": "Deaktivieren",
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build kann nur automatisch registriert werden, wenn openccx unter einer Loopback-Adresse läuft. Der vorherige Block mit Verweis auf Loopback wurde entfernt.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build kann nur automatisch registriert werden, wenn openccx unter einer Loopback-Adresse läuft. Es gab keinen vorherigen Block zu entfernen.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build kann nur automatisch registriert werden, wenn openccx unter einer Loopback-Adresse läuft. Inzwischen hat eine andere Stelle einen neuen Block in die Konfiguration geschrieben; der aktuelle Block in der Datei wurde daher nicht von dieser Anfrage erstellt.",
  "integrations.native.error.orphanedMarker": "{path} enthält eine openccx-Startmarkierung, aber keine Endmarkierung. Die Datei wurde nicht geändert, weil das Ende des Blocks nicht sicher bestimmt werden kann.",
  ...
  "integrations.onboarding": "Beim Anwenden wird nach dem Speichern einer Sicherung genau ein openccx-Anbieterblock geschrieben. Beim Deaktivieren wird nur dieser Block entfernt; eine aufbewahrte Momentaufnahme kann wiederhergestellt werden.",
  "integrations.empty.title": "Keine installierten Clients erkannt",
  "integrations.empty.body": "Installiere einen unterstützten Client und kehre dann hierher zurück, um openccx anzuwenden.",
  ...
  "integrations.error.conflict": "Die Konfiguration wurde geändert, nachdem openccx sie geschrieben hatte. Es wurde nichts entfernt.",
  ...
  "integrations.bulk.body": "Nur der openccx-eigene Block wird entfernt. Für jeden Client wird vorher eine Momentaufnahme gespeichert.",
  ...
  "integrations.dialog.overwrite.changesUnowned": "In {path} belegt ein Block, den nicht wir geschrieben haben, die Stelle, die openccx braucht. Beim Anwenden wird er durch den Block ersetzt, den openccx schreibt.",
  "integrations.dialog.overwrite.changesForeign": "Deine Änderung im openccx-Block in {path} wird verworfen und durch den Block ersetzt, den openccx schreibt.",
  ...
  "integrations.semantics.opencode": "Gilt nur für direkte Starts von der Festplatte; die Umgebungsinjektion von occx opencode hat Vorrang.",
  ...
  "integrations.semantics.dsh": "Openccx verwaltet nur llm-pi-ai.providers.openccx in $DSH_HOME/settings.yaml. DSH lädt diesen Anbieter im laufenden Betrieb neu; Ihr Standardmodell und deepseek-official bleiben unverändert. Derzeit nur über Loopback; es werden keine echten Zugangsdaten geschrieben.",
  "integrations.semantics.mcode": "Verwaltet nur custom_provider.openccx. Standardmodell und MiniMax-Anmeldung bleiben unverändert.",
  "integrations.semantics.zcode": "Verwaltet nur provider.openccx in ~/.zcode/v2/config.json. Z.ai-Anmeldung und andere Provider bleiben unverändert. ZCode nach Änderungen neu starten.",
  "integrations.semantics.prime": "Verwaltet nur providers.openccx in der models.json von Prime Agent — ~/.prime/agent, sofern PRIME_AGENT_CODING_AGENT_DIR sie nicht umleitet. Andere Provider und Modell-Overrides bleiben unverändert. Gilt für neue Sitzungen.",
  "integrations.semantics.aside": "Verwaltet nur providers.openccx in der ~/.aside/u/<id>/models.json dieses Profils. Andere Provider bleiben unverändert. Beende Aside nach dem Anwenden vollständig und öffne es erneut.",
  "integrations.semantics.raycast": "Fügt einen Openccx-Provider-Eintrag in die providers.yaml von Raycast ein, damit jedes geroutete Modell in der Modellauswahl von Raycast AI erscheint. Raycast Pro erforderlich.",
  "integrations.semantics.omo": "Verwaltet ausschließlich providers.openccx in der models.json von omo — ~/.omo/agent, sofern nicht OMO_CODING_AGENT_DIR, SENPI_CODING_AGENT_DIR oder PI_CODING_AGENT_DIR sie umleitet. Ihre übrigen Provider bleiben unverändert. Gilt ab neuen Sitzungen.",
  "integrations.semantics.cline": "Verwaltet Openccx in providers.json und models.json der Cline CLI. Beenden Sie Cline vor Änderungen oder Synchronisierung und starten Sie es danach neu. Rückgängig stellt beide Originaldateien wieder her. Ihr Standardanbieter bleibt unverändert; wählen Sie Openccx in Cline.",
  ...
  "codexAuth.catalogRefreshPending": "Die Änderung wurde gespeichert, aber die Aktualisierung des Codex-Modellkatalogs steht noch aus. Führe occx sync aus, um es erneut zu versuchen.",
  ...
  "accountPool.strategyDesc": "Wie Openccx einer neuen/ungebundenen Aufgabe ein Konto zuweist.",
  ...
  "api.subtitle": "Mit generierten API-Schlüsseln greifen externe Apps auf den openccx-Proxy zu. Die Authentifizierung läuft über den {authHeader}-Header; welche Header ein Endpunkt akzeptiert, steht in der Tabelle unten.",
  ...
  "api.authLoopback": "Loopback-Binds (127.0.0.1 oder ::1) umgehen die Authentifizierung. Remote-Binds benötigen einen generierten occx_-Schlüssel oder OPENCCX_API_AUTH_TOKEN.",
  ...
  "claude.injectAgentsDesc": "Registriert die im Subagenten-Tab gewählten Modelle (plus das aktuelle Standardmodell) als aufrufbare Claude-Code-Agenten (occx-*). Gilt ab der nächsten Sitzung.",
  ...
  "claude.smallFastModelNativeWarning": "Wenn kein Modell gewählt ist, setzt Openccx keine Hilfsmodell-Overrides. Claude Code kann dann sein natives Sonnet-Modell verwenden, wodurch Kosten bei deinem nativen Anbieter entstehen können.",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.copyDoctor": "occx doctor kopieren",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.howBody": "Fordern Sie in Codex den öffentlichen Modellnamen der Combo an. Ohne eigenen Namen gilt combo/<id>. Openccx wählt ein Ziel und springt nur bei wiederholbaren Upstream-Fehlern. Ist kein Ziel verfügbar, schlägt die Anfrage geschlossen fehl, statt den globalen Standardanbieter zu verwenden.",
  ...
  "grok.subtitle": "Modelle, die openccx in deiner Grok-Konfiguration registriert hat.",
  ...
  "grok.notConfiguredHint": "Starte den Proxy mit installiertem Grok neu; openccx schreibt dann einen verwalteten Block nach:",
  ...
  "dash.codexClientCompactionHint": "Standardmäßig aus; nur für authentifiziertes Loopback-Routing. Künftige Komprimierungen speichern portable Klartext-Zusammenfassungen, während das OpenCodeX-Provider-Routing und die V2-Subagent-Zustellung aktiv bleiben; der konfigurierte Anbieter kann sie verarbeiten und Kontingent verbrauchen. Vorhandene occx1-Verläufe müssen weiterhin wiederhergestellt werden. Codex nach einer Änderung neu starten.",
  ...
  "integrations.cursor.apiKeyCredential": "Einer Ihrer openccx-API-Schlüssel (für diese Anbindung sind Zugangsdaten erforderlich)",
  ...
  "integrations.cursor.modelsHint": "Cursor wählt die Reasoning-Abstufung anhand seiner eigenen Modelltabelle aus, daher kann openccx sie nur vorhersagen. Die Kontextspalte zeigt das Standardfenster und das optionale Fenster (Cursors Max Mode).",
  "integrations.cursor.ladderFromBundle": "Reasoning-Abstufungen wurden aus dem installierten Cursor-Private-Inference-Bundle {version} gelesen. Cursor legt sie fest; openccx gibt nur dessen Tabelle wieder.",
