...
- 기존 구현 및 제약 조건: Compaction handling was binary — `occx1:` envelopes were ours, everything
...
- 장점, 단점 및 영향: A cross-backend session degrades one compaction summary to a note instead of
  ...
  other routed gateways see a note because routed compaction produces an `occx1:` envelope.
