...
export const NATIVE_MAIN_OWNER_DB = ".openccx-native-main.owner.sqlite";
...
export function assertNativeMainOwner(context: NativeProfileContext): void {
  ...
  throw new NativeProfileError(
    ...
    unavailable
      ...
      : "Another Openccx process owns the physical native-main login for the effective CODEX_HOME.",
    503,
    true,
  );
}
