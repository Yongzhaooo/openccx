...
import type { OccxConfig, OccxProviderConfig, OccxParsedRequest } from "../../src/types";
...
function makeConfig(
  providers: Record<string, Partial<OccxProviderConfig>>,
...
function makeParsed(withImageGen: boolean): OccxParsedRequest {
  return {
    modelId: "test-model",
...
const routed = { adapter: "openai-chat", baseUrl: "https://api.anthropic.com" } as OccxProviderConfig;
const openaiRouted = { adapter: "openai-chat", baseUrl: "https://api.openai.com" } as OccxProviderConfig;
