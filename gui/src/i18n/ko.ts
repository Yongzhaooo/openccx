...
"common.discard": "버리기",
  ...
  "common.retry": "재시도",
  "auth.adminTokenTitle": "Openccx 관리자 토큰 (OPENCCX_ADMIN_AUTH_TOKEN)",
  ...
  "auth.adminTokenHelp": "이 값은 Openccx 관리 API의 관리자 토큰이며 공급자 API 키가 아닙니다. 프록시가 처음 실행될 때 ~/.opencodex/admin-api-token(또는 $OPENCCX_HOME/admin-api-token)에 기록하고, OPENCCX_ADMIN_AUTH_TOKEN을 설정하면 그 값이 우선합니다.",
  ...
  "startup.subtitle": "재부팅 후 로컬 프록시 라우팅이 재연결 반복으로 이어지기 전에 Codex가 openccx에 연결될 수 있는지 확인합니다.",
  ...
  "startup.summary.protected": "재부팅 후에도 openccx가 자동으로 준비됩니다",
  ...
  "startup.riskDetailCustomLocal": "Codex가 사용자 지정 로컬 게이트웨이를 바라봅니다. openccx는 해당 게이트웨이의 재시작 수명주기를 관리하거나 검증할 수 없습니다.",
  "startup.riskDetailWindowsShim": "Launcher shim은 지원되는 CLI 스크립트만 보호하며 Windows의 Codex Desktop과 직접 codex.exe 실행은 이를 우회할 수 있습니다.",
  "startup.safeDetail": "현재 라우팅과 시작 방식이 일치합니다. 재부팅 후 occx start를 수동으로 실행할 필요가 없습니다.",
  ...
  "startup.shimHint": "지원되는 Codex 스크립트 런처가 시작될 때 occx ensure를 실행합니다.",
  "startup.healthy": "정상",
  ...
  "startup.tray.error": "Windows 트레이 작업에 실패했습니다. occx tray status에서 상세 내용을 확인하세요.",
  ...
  "startup.codexRuntime.clampHidden": "Openccx가 Codex {version}을(를) 사용해 일부 reasoning effort 옵션이 숨겨졌습니다.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Openccx가 Codex {version}을(를) 사용해 일부 reasoning effort 옵션이 숨겨졌습니다(제거됨: {efforts}).",
  "startup.codexRuntime.olderBinary": "Openccx가 더 오래된 Codex 바이너리({version})를 사용 중입니다. 더 새 설치를 사용할 수 있습니다.",

  // dashboard
  "dash.subtitle": "로컬 openccx 프록시와 프로바이더, 그리고 Codex로 라우팅되는 모델의 실시간 상태입니다.",
  ...
  "dash.codexAutoStart": "Codex 실행 시 openccx 시작",
  "dash.codexAutoStartHint": "설치된 launcher shim이 occx ensure를 실행하도록 허용합니다. 이 설정은 재부팅 보호를 설치하지 않으므로 시작 안전성에서 실제 상태를 확인하세요.",
  ...
  "dash.shadowCallTooltip": "Codex 앱은 스레드 제목 자동 생성, 커밋 메시지 생성, 스킬 오케스트레이션 같은 내부 작업을 백그라운드로 호출합니다. 이때 쓰는 모델은 클라이언트 버전마다 달라서 openccx는 {models}를 모두 가로챕니다. 이 설정을 켜면 해당 호출이 선택한 모델로 넘어갑니다.",
  ...
  "dash.maintenanceHint": "Codex 모델 카탈로그를 새로고침하거나 최신 openccx 릴리스를 설치합니다.",
  ...
  "dash.projectConfigTitle": "프로젝트 Codex 설정이 Openccx를 우회합니다",
  "dash.projectConfigHint": "저장소 로컬 설정이 Openccx 프록시를 덮어씁니다(예: OpenCode Go로 직접 라우팅). 해당 프로젝트에서 ~/.codex/config.toml 프록시를 쓰려면 제거하세요.",
  "dash.checkUpdate": "업데이트 확인",
  "dash.updateTitle": "openccx 업데이트",
  ...
  "dash.updateStatus.running": "openccx 업데이트 중입니다.",
  ...
  // providers
  "prov.subtitle": "openccx가 Codex로 라우팅하는 업스트림 프로바이더를 설정합니다. 계정으로 로그인하거나, 프로바이더를 추가하거나, 원본 설정을 편집하세요.",
  "prov.add": "프로바이더 추가",
  ...
  "oauthTos.anthropicBody": "Claude 구독 OAuth 토큰을 Openccx 같은 타사 프록시에서 직접 재사용하는 방식은 Anthropic이 지원하는 통합이 아니며 접근이 제한될 수 있습니다. Claude 구독을 사용하는 공식 Agent SDK 통합은 별도입니다.",
  "oauthTos.highBody": "Openccx는 {provider}를 타사 OAuth 경로로 연결합니다. 지원되지 않는 사용 방식이면 접근이 제한되거나 정지될 수 있습니다.",
  "oauthTos.elevatedBody": "Openccx는 {provider}를 비공식 OAuth 경로로 연결합니다. 가능하면 공식 클라이언트를 사용하세요. 비정상적이거나 자동화된 트래픽은 남용으로 간주되어 접근이 제한되거나 정지될 수 있습니다.",
  "oauthTos.saferPath": "더 안전한 방법: Openccx에 API 키를 대신 설정하세요.",
  ...
  "models.subtitle": "Codex가 보는 모델을 켜고 끕니다 — 네이티브 GPT passthrough와 라우팅된 모델을 프로바이더별로 묶어 보여줍니다(헤더를 클릭하면 접힘). 숨긴 모델은 카탈로그와 선택기에서 빠지지만 정확한 id로 직접 호출할 수 있습니다. 변경 사항은 다음 Codex 턴에 적용됩니다 — openccx가 Codex의 5분 모델 캐시를 무효화하므로 재시작이 필요 없습니다.",
  ...
  // subagents
  "sub.subtitle": "Codex의 {cmd} 는 우선순위 상위 5개 모델만 오버라이드로 노출합니다. 여기서 최대 5개를 선택하면 — 네이티브 gpt 또는 라우팅된 모델 — openccx가 카탈로그 우선순위를 설정해 정확히 이들이 앞에 옵니다. 다른 모델도 정확한 이름으로 호출할 수 있으며, 이 설정은 표시 항목만 제어합니다.",
  "sub.featured": "추천",
  "sub.advanced": "고급",
  ...
  "logs.tabLogs": "로그",
  "logs.tabDebug": "디버그",
  "logs.subtitle": "로컬 openccx 프록시를 거친 최근 요청입니다. 최신순.",
...
"codexSet.custom.moveUp": "{title} 위로 이동",
  ...
  "codexSet.custom.notOwned": "developer_instructions가 openccx 외부에서 작성되어 여기서는 편집할 수 없습니다. 레이어로 관리하려면 가져오세요.",
  "codexSet.custom.adopt": "기존 지침 가져오기",
  "codexSet.custom.adoptConfirm": "레이어로 가져오기",
  "codexSet.custom.adoptRefused": "기존 값을 가져오지 못했습니다.",
  "codexSet.custom.baseReplaced": "model_instructions_file이 {path}(으)로 설정되어 openccx 외부에서 기본 프롬프트를 교체했습니다.",
...
"codexSet.lint.size": "이 레이어는 8 KB를 초과합니다. 저장은 가능하지만 요청마다 토큰을 사용합니다.",
  ...
  "codexSet.preset.korean.provenance": "자주 요청되는 항목을 바탕으로 openccx용으로 작성했습니다. 직접 작성한 문구이며 복사본이 아닙니다.",
...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
  ...
  "codexSet.base.externalBlocked": "model_instructions_file이 이미 {path}를 가리키고 있고, openccx가 쓴 값이 아닙니다. 직접 지운 뒤 여기서 선택하세요.",
  "nav.openMenu": "메뉴 열기",
  "nav.closeMenu": "메뉴 닫기",
  "nav.goHome": "대시보드로 이동",
  "pws.refreshAllQuotas": "전체 할당량 갱신",
  "pws.quotaRefreshDone": "할당량 조회를 마쳤습니다",
  "integrations.subtitle": "클라이언트를 openccx에 연결하고 자격 증명과 설정 복원을 관리합니다.",
  ...
  "integrations.codex.body": "Codex 연결은 프록시 서비스가 관리합니다. openccx를 시작하면 적용되고 서비스를 중지하면 기본 라우팅으로 복원됩니다.",
  ...
  "integrations.dialog.desktop.changes": "{path}에 openccx 게이트웨이 프로필이 있으면 먼저 자격 증명 없는 표준 프로필을 선택한 뒤 이전 프로필과 백업을 제거합니다.",
  "integrations.dialog.desktop.breakage": "Claude Desktop은 openccx를 통한 모델 대신 표준 Claude로 돌아갑니다.",
  "integrations.dialog.desktop.undo": "다시 켜면 저장된 모델 할당으로 openccx 프로필을 새로 만듭니다.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop은 표준 모드를 가리키지만 이전 openccx 자격 증명 파일이 남아 있습니다: {paths}.",
  ...
  "integrations.detail.grokAbsent": "설정에 openccx 블록이 없습니다",
  "integrations.dialog.codex.title": "Codex 통합을 끌까요?",
  "integrations.dialog.codex.changes": "{path}에서 openccx 라우팅을 제거하고 생성한 프로필을 삭제하며, 기본 Codex 모델 카탈로그를 복원하고, 재개 가능한 스레드에 기본 Codex 태그를 다시 붙입니다.",
  ...
  "integrations.dialog.codex.sideEffect": "openccx가 구성을 주입한 뒤 라우팅된 루트 모델을 선택했다면, 해제할 때 그 모델 선택도 제거되며 다시 켜도 복원할 수 없습니다. 모델을 다시 선택하세요. 외부 model_provider가 Codex를 소유하면 openccx는 오래된 저널만 제거하고 구성, 카탈로그, 기록은 그대로 둡니다.",
  "integrations.dialog.codex.confirm": "해제",
  "integrations.dialog.grok.title": "Grok Build 연동을 해제할까요?",
  "integrations.dialog.grok.changes": "{path}에서 openccx가 표시해 둔 블록만 제거합니다. 블록 바깥에 직접 쓴 내용은 그대로 둡니다.",
  "integrations.dialog.grok.breakage": "해제하면 Grok Build에서 openccx 모델 별칭이 사라집니다. xAI 계정으로 쓰던 모델은 그대로입니다.",
  "integrations.dialog.grok.undo": "openccx가 loopback 주소로 실행 중이면, 다시 켤 때 지금 쓸 수 있는 모델 목록으로 블록을 새로 씁니다.",
  "integrations.dialog.grok.confirm": "해제",
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build은 openccx가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. loopback 주소를 가리키던 이전 블록은 제거했습니다.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build은 openccx가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. 제거할 이전 블록은 없었습니다.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build은 openccx가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. 그 사이 다른 곳에서 설정에 블록이 새로 쓰여, 지금 파일에 있는 블록은 이 요청이 만든 것이 아닙니다.",
  "integrations.native.error.orphanedMarker": "{path}에 openccx 시작 표시는 있는데 끝 표시가 없습니다. 어디까지가 우리 블록인지 확신할 수 없어 파일을 건드리지 않았습니다.",
  ...
  "integrations.onboarding": "적용하면 먼저 백업을 보관한 뒤 openccx 제공자 블록 하나만 씁니다. 해제는 그 블록만 제거하며 보관된 스냅샷으로 복원할 수 있습니다.",
  "integrations.empty.title": "설치된 클라이언트가 감지되지 않았습니다",
  "integrations.empty.body": "지원 클라이언트를 설치한 뒤 돌아와 openccx를 적용하세요.",
  ...
  "integrations.error.conflict": "openccx가 쓴 뒤 설정이 변경되었습니다. 아무 내용도 제거하지 않았습니다.",
  ...
  "integrations.bulk.body": "openccx가 소유한 블록만 제거합니다. 각 클라이언트의 변경 전 스냅샷을 보관합니다.",
  ...
  "integrations.dialog.overwrite.changesUnowned": "{path}에서 openccx가 써야 하는 자리를 우리가 쓰지 않은 블록이 차지하고 있습니다. 적용하면 openccx가 쓰는 블록으로 바꿉니다.",
  "integrations.dialog.overwrite.changesForeign": "{path}의 openccx 블록에 직접 넣은 수정은 버리고 openccx가 쓰는 블록으로 바꿉니다.",
  ...
  "integrations.semantics.opencode": "디스크에서 직접 실행할 때만 적용됩니다. occx opencode의 환경 주입이 우선합니다.",
  ...
  "integrations.semantics.dsh": "Openccx는 $DSH_HOME/settings.yaml의 llm-pi-ai.providers.openccx만 관리합니다. DSH는 이 provider를 hot reload하며 기본 model과 deepseek-official은 변경하지 않습니다. 현재 loopback 전용이며 실제 credential을 기록하지 않습니다.",
  "integrations.semantics.mcode": "custom_provider.openccx만 관리하며 기본 모델과 MiniMax 로그인은 변경하지 않습니다.",
  "integrations.semantics.zcode": "~/.zcode/v2/config.json의 provider.openccx만 관리하며 Z.ai 로그인과 다른 프로바이더는 변경하지 않습니다. 변경 후 ZCode를 재시작하세요.",
  "integrations.semantics.prime": "Prime Agent의 models.json에서 providers.openccx만 관리합니다. 위치는 ~/.prime/agent이며 PRIME_AGENT_CODING_AGENT_DIR가 설정되면 그쪽이 우선합니다. 다른 프로바이더와 모델 오버라이드는 변경하지 않습니다. 새 세션부터 적용됩니다.",
  "integrations.semantics.aside": "이 프로필의 ~/.aside/u/<id>/models.json에서 providers.openccx만 관리합니다. 다른 프로바이더는 그대로 유지됩니다. 적용 후 Aside를 완전히 종료하고 다시 여세요.",
  "integrations.semantics.raycast": "Raycast의 providers.yaml에 Openccx 프로바이더 항목을 추가해 라우팅된 모든 모델이 Raycast AI 모델 선택기에 표시되도록 합니다. Raycast Pro가 필요합니다.",
  "integrations.semantics.omo": "omo의 models.json에서 providers.openccx만 관리합니다. 위치는 ~/.omo/agent이며 OMO_CODING_AGENT_DIR, SENPI_CODING_AGENT_DIR, PI_CODING_AGENT_DIR 중 설정된 값이 있으면 그쪽이 우선합니다. 다른 프로바이더는 그대로 유지됩니다. 새 세션부터 적용됩니다.",
  "integrations.semantics.cline": "Cline CLI의 providers.json과 models.json에서 Openccx 항목을 관리합니다. 변경·동기화 전에 Cline을 종료하고 완료 후 다시 실행하세요. 되돌리기는 두 파일의 원본을 복원합니다. 기본 프로바이더는 유지되므로 Cline에서 Openccx를 선택하세요.",
  ...
  "codexAuth.catalogRefreshPending": "변경 사항은 저장되었지만 Codex 모델 카탈로그 새로 고침이 보류 중입니다. occx sync를 실행해 다시 시도하세요.",
  ...
  "accountPool.strategyDesc": "Openccx가 새 작업/바인딩 없는 작업에 계정을 배정하는 방식입니다.",
  ...
  // api access page
  "api.title": "API 액세스",
  "api.subtitle": "생성한 API 키로 외부 앱에서 openccx 프록시에 접속합니다. 인증은 {authHeader} 헤더로 하며, 엔드포인트별로 받는 헤더는 아래 표에 있습니다.",
  ...
  "api.authTitle": "인증",
  "api.authLoopback": "루프백 바인드(127.0.0.1 또는 ::1)는 인증을 건너뜁니다. 원격 바인드는 생성된 occx_ 키 또는 OPENCCX_API_AUTH_TOKEN이 필요합니다.",
  ...
  "claude.authModeHint": "subscription은 Claude 계정 필요, proxy는 openccx 프록시만으로 사용 가능",
  ...
  "claude.injectAgentsDesc": "위 '서브에이전트' 탭에서 고른 모델들(+현재 기본 모델)을 Claude Code의 파견 가능한 에이전트(occx-*)로 자동 등록합니다. 새 세션부터 적용돼요.",
  ...
  "claude.smallFastModelNativeWarning": "비워 두면 Openccx가 보조 모델 환경 변수를 설정하지 않습니다. Claude Code가 네이티브 Sonnet 모델을 사용할 수 있으며, 네이티브 프로바이더 요금이 발생할 수 있습니다.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.count.other": "기타",
  "cws.howTitle": "동작 방식",
  "cws.howBody": "Codex에서 콤보의 공개 모델 이름을 요청하세요. 설정하지 않으면 combo/<id>가 기본값입니다. Openccx는 재시도 가능한 업스트림 오류에서만 다음 대상으로 넘깁니다. 사용 가능한 대상이 없으면 전역 기본 프로바이더로 우회하지 않고 요청을 실패 처리합니다.",
  ...
  "grok.subtitle": "openccx가 Grok 설정에 등록한 모델입니다.",
  "grok.loading": "Grok 상태를 불러오는 중…",
  "grok.loadFail": "Grok 설정을 읽지 못했습니다.",
  "grok.notConfiguredTitle": "Grok Build가 연결되지 않았습니다",
  "grok.notConfiguredHint": "Grok을 설치한 뒤 프록시를 다시 시작하면 openccx가 관리 블록을 다음 위치에 씁니다:",
  "grok.endpoint": "엔드포인트",
  "grok.colModel": "모델",
  ...
  "integrations.cursor.intro": "Cursor Private Inference는 에이전트를 로컬에서 돌리고 loopback으로 openccx와 통신합니다. 일반 Cursor는 백엔드가 커스텀 엔드포인트를 호출하므로 공개 HTTPS 주소가 필요합니다. 이 페이지는 Cursor에 아무것도 쓰지 않습니다. 아래 값을 직접 Cursor에 붙여넣으세요.",
  ...
  "integrations.cursor.apiKeyCredential": "openccx API 키 중 하나 (이 바인드는 자격 증명이 필요)",
  ...
  "integrations.cursor.modelsHint": "Reasoning 사다리는 Cursor 자체 모델 표가 정하므로 openccx는 예측만 합니다. Context는 기본 창과 옵트인 창(Cursor의 Max Mode)입니다.",
  "integrations.cursor.ladderFromBundle": "Reasoning 사다리는 설치된 Cursor Private Inference {version} 번들에서 읽었습니다. 사다리는 Cursor가 정하고 openccx는 그 표를 보여줄 뿐입니다.",
