...
When adding or redesigning a GUI page, CLI wizard, or user-facing flow in openccx,
...
This is a design-first rule for contributors, not a runtime feature: openccx is infrastructure
...
| `occx init` CLI | Flat numbered menu, no personality | Could benefit from staged approach |
